...
class FournisseurServiceImplTest {
     ...
     */
    @Test
    void testRetrieveAllFournisseurs3() {
        DetailFournisseur detailFournisseur = new DetailFournisseur();
        detailFournisseur.setAdresse("Adresse");
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        detailFournisseur.setDateDebutCollaboration(Date.from(atStartOfDayResult.atZone(ZoneId.of("UTC")).toInstant()));
    ...
    void testAddFournisseur2() {
        ...
        detailFournisseur3.setIdDetailFournisseur(1L);
        detailFournisseur3.setMatricule("Matricule");
        Fournisseur fournisseur4 = mock(Fournisseur.class);
        doNothing().when(fournisseur4).setCategorieFournisseur((CategorieFournisseur) any());
        doNothing().when(fournisseur4).setCode((String) any());
        doNothing().when(fournisseur4).setDetailFournisseur((DetailFournisseur) any());
        doNothing().when(fournisseur4).setFactures((Set<Facture>) any());
        doNothing().when(fournisseur4).setIdFournisseur((Long) any());
        doNothing().when(fournisseur4).setLibelle((String) any());
        doNothing().when(fournisseur4).setSecteurActivites((Set<SecteurActivite>) any());
        fournisseur4.setCategorieFournisseur(CategorieFournisseur.ORDINAIRE);
        fournisseur4.setCode("Code");
        fournisseur4.setDetailFournisseur(detailFournisseur3);
        fournisseur4.setFactures(new HashSet<>());
        ...
        fournisseur4.setLibelle("Libelle");
        fournisseur4.setSecteurActivites(new HashSet<>());
        fournisseurServiceImpl.addFournisseur(fournisseur4);
        verify(fournisseurRepository).save((Fournisseur) any());
        verify(fournisseur4).setCategorieFournisseur((CategorieFournisseur) any());
        verify(fournisseur4).setCode((String) any());
        verify(fournisseur4, atLeast(1)).setDetailFournisseur((DetailFournisseur) any());
        verify(fournisseur4).setFactures((Set<Facture>) any());
        verify(fournisseur4).setIdFournisseur((Long) any());
        verify(fournisseur4).setLibelle((String) any());
        verify(fournisseur4).setSecteurActivites((Set<SecteurActivite>) any());
    }
